...
$TCA['tx_socialservices_domain_model_district'] = array(
	'ctrl' => $TCA['tx_socialservices_domain_model_district']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, district',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, district,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'district' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:socialservices/Resources/Private/Language/locallang_db.xlf:tx_socialservices_domain_model_district.district',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
